...
/opt/nginx/sbin/nginx -p /home/picuntu/workspace/sCamera -t -c conf/nginx.conf
/opt/nginx/sbin/nginx -p /home/picuntu/workspace/sCamera -t -c conf/nginx.wvCamera.conf
