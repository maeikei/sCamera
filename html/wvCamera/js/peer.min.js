/*! peerjs.min.js build:0.3.6, production. Copyright(c) 2013 Michelle Bu <michelle@michellebu.com> */
(function(e) {
  function n() {
  ...
  function u(e, t) {
    ...
    this._dc = e, l.debug = t, this._outgoing = {}, this._incoming = {}, this._received = {}, this._window = 1e3, this._mtu = 500, this._interval = 0, this._count = 0, this._queue = [], this._setupDC()
  }
  function c(e, t) {
    if (!(this instanceof c)) return new c(e, t);
    s.call(this), e && e.constructor == Object ? (t = e, e = undefined) : e && (e = e.toString()), t = l.extend({
      debug: 0,
      host: l.CLOUD_HOST,
      port: l.CLOUD_PORT,
      key: "peerjs",
      config: l.defaultConfig
    }, t), this.options = t, t.host === "/" && (t.host = window.location.hostname), t.secure === undefined && t.host !== l.CLOUD_HOST && (t.secure = l.isSecure()), t.logFunction && l.setLogFunction(t.logFunction), l.setLogLevel(t.debug);
    if (!l.supports.audioVideo && !l.supports.data) {
    ...
    this.destroyed = !1, this.disconnected = !1, this.open = !1, this.connections = {}, this._lostMessages = {};
    var n = this;
    this.socket = new v(this.options.secure, this.options.host, this.options.port, this.options.key), this.socket.on("message", function(e) {
      n._handleMessage(e)
    }), this.socket.on("error", function(e) {
      n._abort("socket-error", e)
    }), this.socket.on("close", function() {
      n.disconnected || n._abort("socket-closed", "Underlying socket is already closed.")
    }), e ? this._initialize(e) : this._retrieveId()
  }
  function h(e, t, n) {
    if (!(this instanceof h)) return new h(e, t, n);
    s.call(this), this.options = l.extend({
      serialization: "binary",
      reliable: !1
    }, n), this.open = !1, this.type = "data", this.peer = e, this.provider = t, this.id = this.options.connectionId || h._idPrefix + l.randomToken(), this.label = this.options.label || this.id, this.metadata = this.options.metadata, this.serialization = this.options.serialization, this.reliable = this.options.reliable, this._buffer = [], this._buffering = !1, this.bufferSize = 0, this._chunkedData = {}, d.startConnection(this, this.options._payload || {
      originator: !0
    })
  }
  function p(e, t, n) {
    if (!(this instanceof p)) return new p(e, t, n);
    s.call(this), this.options = l.extend({}, n), this.open = !1, this.type = "media", this.peer = e, this.provider = t, this.metadata = this.options.metadata, this.localStream = this.options._stream, this.id = this.options.connectionId || p._idPrefix + l.randomToken(), this.localStream && d.startConnection(this, {
      _stream: this.localStream,
      originator: !0
    })
  }
  function v(e, t, n, r) {
    if (!(this instanceof v)) return new v(e, t, n, r);
    s.call(this), this.disconnected = !1, this._queue = [];
    var i = e ? "https://" : "http://",
      o = e ? "wss://" : "ws://";
    this._httpUrl = i + t + ":" + n + "/" + r, this._wsUrl = o + t + ":" + n + "/peerjs?key=" + r
  }
  var t = {};
  ...
  }(), t.useArrayBufferView = !t.useBlobBuilder &&
  function() {
    try {
  ...
  s.prototype.addListener = function(e, t, n, r) {
    ...
    }, l.debug && (this._outgoing[this._count].timer = new Date), this._sendWindowedChunks(this._count), this._count += 1
  }, u.prototype._setupInterval = function() {
    var e = this;
  ...
  }, u.prototype._intervalSend = function(e) {
    var t = this;
    e = l.pack(e), l.blobToBinaryString(e, function(e) {
      t._dc.send(e)
    }), t._queue.length === 0 && (clearTimeout(t._timeout), t._timeout = null)
  }, u.prototype._processAcks = function() {
    for (var e in this._outgoing) this._outgoing.hasOwnProperty(e) && this._sendWindowedChunks(e)
  }, u.prototype._handleSend = function(e) {
    var t = !0;
  ...
  }, u.prototype._setupDC = function() {
    var e = this;
    this._dc.onmessage = function(t) {
      var n = t.data,
        r = n.constructor;
      if (r === String) {
        var i = l.binaryStringToArrayBuffer(n);
        n = l.unpack(i), e._handleMessage(n)
      }
    }
    ...
    case "ack":
      ...
      if ( !! i) {
        var o = e[2];
        i.ack = Math.max(o, i.ack), i.ack >= i.chunks.length ? (l.log("Time: ", new Date - i.timer), delete this._outgoing[t]) : this._processAcks()
      }
      break;
    case "chunk":
      i = n;
    ...
    return l.log("Created", t.length, "chunks."), t
  }, u.prototype._ack = function(e) {
    var t = this._incoming[e].ack;
    this._received[e] === t[2] && (this._complete(e), this._received[e] = !0), this._handleSend(t)
  }, u.prototype._calculateNextAck = function(e) {
    ...
    t.ack[2] = n.length
  }, u.prototype._sendWindowedChunks = function(e) {
    l.log("sendWindowedChunks for: ", e);
    ...
    l.log("Completed called for", e);
    var t = this,
      n = this._incoming[e].chunks,
      r = new Blob(n);
    l.blobToArrayBuffer(r, function(e) {
      t.onmessage(l.unpack(e))
    }), delete this._incoming[e]
  }, u.higherBandwidthSDP = function(e) {
    ...
    return e
  }, u.prototype.onmessage = function(e) {}, e.Reliable = u, e.RTCSessionDescription = window.mozRTCSessionDescription || window.RTCSessionDescription, e.RTCPeerConnection = window.mozRTCPeerConnection || window.webkitRTCPeerConnection || window.RTCPeerConnection, e.RTCIceCandidate = window.mozRTCIceCandidate || window.RTCIceCandidate;
  var a = {
    iceServers: [{
    ...
    l = {
      ...
      setLogLevel: function(e) {
        var t = parseInt(e, 10);
        isNaN(parseInt(e, 10)) ? l.logLevel = e ? 3 : 0 : l.logLevel = t, l.log = l.warn = l.error = l.noop, l.logLevel > 0 && (l.error = l._printWith("ERROR")), l.logLevel > 1 && (l.warn = l._printWith("WARNING")), l.logLevel > 2 && (l.log = l._print)
      },
      setLogFunction: function(e) {
        e.constructor !== Function ? l.warn("The log function you passed in is not a function. Defaulting to regular logs.") : l._print = e
      },
      _printWith: function(e) {
        return function() {
          var t = Array.prototype.slice.call(arguments);
          t.unshift(e), l._print.apply(l, t)
        }
      },
      _print: function() {
        var e = !1,
      ...
      supports: function() {
        ...
        if (e) {
          ...
          var f = new RTCPeerConnection(a, {});
          try {
            var c = f.createDataChannel("_PEERJSRELIABLETEST", {});
            r = c.reliable
          } catch (u) {}
          f.close()
        }
        t && (t = !! s.addStream);
        if (!i && e) {
          var h = new RTCPeerConnection(a, {
            optional: [{
              RtpDataChannels: !0
            }]
          });
          h.onnegotiationneeded = function() {
            i = !0, l && l.supports && (l.supports.onnegotiationneeded = !0)
          };
          var p = h.createDataChannel("_PEERJSNEGOTIATIONTEST");
          setTimeout(function() {
            h.close()
          }, 1e3)
        }
      ...
      chunk: function(e) {
        var t = [],
          n = e.size,
          r = index = 0,
          i = Math.ceil(n / l.chunkedMTU);
        while (r < n) {
          var s = Math.min(n, r + l.chunkedMTU),
            o = e.slice(r, s),
            u = {
              __peerData: f,
              n: index,
  ...
  e.util = l, l.inherits(c, s), c.prototype._retrieveId = function(e) {
    var t = this,
      n = new XMLHttpRequest,
      r = this.options.secure ? "https://" : "http://",
      i = r + this.options.host + ":" + this.options.port + "/" + this.options.key + "/id",
      s = "?ts=" + (new Date).getTime() + "" + Math.random();
    i += s, n.open("get", i, !0), n.onerror = function(e) {
      l.error("Error retrieving ID", e), t._abort("server-error", "Could not get an ID from the server")
    ...
    var t = this;
    this.id = e, this.socket.start(this.id)
    ...
    case "INVALID-KEY":
      ...
      break;
    case "LEAVE":
      l.log("Received leave message from", r), this._cleanupPeer(r);
      break;
    case "EXPIRE":
      this.emit("error", new Error("Could not connect to peer " + r));
      break;
    case "OFFER":
      var i = n.connectionId,
        s = this.getConnection(r, i);
      if (s) l.warn("Offer received for existing Connection ID:", i);
      else {
        if (n.type === "media") {
          var s = new p(r, this, {
            connectionId: i,
          ...
          if (n.type !== "data") {
            l.warn("Received malformed connection type:", n.type);
            return
          }
          s = new h(r, this, {
            connectionId: i,
    ...
    default:
      if (!n) {
        l.warn("You received a malformed message from " + r + " of type " + t);
        return
      }
      var f = n.connectionId,
        s = this.getConnection(r, f);
      s && s.pc ? s.handleMessage(e) : f ? this._storeMessage(f, e) : l.warn("You received an unrecognized message:", e)
    }
  }, c.prototype._storeMessage = function(e, t) {
    this._lostMessages[e] || (this._lostMessages[e] = []), this._lostMessages[e].push(t)
  }, c.prototype._getMessages = function(e) {
    var t = this._lostMessages[e];
    return t ? (delete this._lostMessages[e], t) : []
  }, c.prototype.connect = function(e, t) {
    if (this.disconnected) {
      l.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."), this.emit("error", new Error("Cannot connect to new Peer after disconnecting from server."));
      return
    }
    var n = new h(e, this, t);
    return this._addConnection(e, n), n
  }, c.prototype.call = function(e, t, n) {
    if (this.disconnected) {
      l.warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect."), this.emit("error", new Error("Cannot connect to new Peer after disconnecting from server."));
      return
    }
    if (!t) {
      l.error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");
      return
    }
    n = n || {}, n._stream = t;
    var r = new p(e, this, n);
    return this._addConnection(e, r), r
  }, c.prototype._addConnection = function(e, t) {
    this.connections[e] || (this.connections[e] = []), this.connections[e].push(t)
  }, c.prototype.getConnection = function(e, t) {
    var n = this.connections[e];
    if (!n) return null;
    for (var r = 0, i = n.length; r < i; r++) if (n[r].id === t) return n[r];
    return null
  }, c.prototype._delayedAbort = function(e, t) {
    var n = this;
    l.setZeroTimeout(function() {
      n._abort(e, t)
    })
  }, c.prototype._abort = function(e, t) {
    l.error("Aborting. Error:", t);
    var n = new Error(t);
    ...
    this.emit("close")
  }, c.prototype._cleanupPeer = function(e) {
    var t = this.connections[e];
    for (var n = 0, r = t.length; n < r; n += 1) t[n].close()
  }, c.prototype.disconnect = function() {
    var e = this;
    l.setZeroTimeout(function() {
      e.disconnected || (e.disconnected = !0, e.open = !1, e.socket && e.socket.close(), e.id = null)
    })
  }, e.Peer = c, l.inherits(h, s), h._idPrefix = "dc_", h.prototype.initialize = function(e) {
    this._dc = this.dataChannel = e, this._configureDataChannel()
  }, h.prototype._configureDataChannel = function() {
    var e = this;
    l.supports.sctp && (this._dc.binaryType = "arraybuffer"), this._dc.onopen = function() {
      l.log("Data channel connection success"), e.open = !0, e.emit("open")
    }, !l.supports.sctp && this.reliable && (this._reliable = new u(this._dc, l.debug)), this._reliable ? this._reliable.onmessage = function(t) {
      e.emit("data", t)
    } : this._dc.onmessage = function(t) {
      e._handleDataMessage(t)
    }, this._dc.onclose = function(t) {
      l.log("DataChannel closed for:", e.peer), e.close()
    }
    ...
    if (this.serialization === "binary" || this.serialization === "binary-utf8") {
      if (r === Blob) {
        l.blobToArrayBuffer(n, function(e) {
          n = l.unpack(e), t.emit("data", n)
        });
        return
      }
      if (r === ArrayBuffer) n = l.unpack(n);
      else if (r === String) {
        var i = l.binaryStringToArrayBuffer(n);
        n = l.unpack(i)
      }
    ...
    if (n.__peerData) {
      ...
      o.data[n.n] = n.data, o.count += 1, o.total === o.count && (n = new Blob(o.data), this._handleDataMessage({
        data: n
      }), delete this._chunkedData[s]), this._chunkedData[s] = o;
      return
    }
    this.emit("data", n)
  }, h.prototype.close = function() {
    if (!this.open) return;
    this.open = !1, d.cleanup(this), this.emit("close")
    ...
    if (this.serialization === "json") this._bufferedSend(JSON.stringify(e));
      ...
      var r = this.serialization === "binary-utf8",
        i = l.pack(e, r);
      if (l.browser !== "Firefox" && !t && i.size > l.chunkedMTU) {
        this._sendChunks(i);
        return
      }
      l.supports.sctp ? l.supports.binaryBlob ? this._bufferedSend(i) : l.blobToArrayBuffer(i, function(e) {
        n._bufferedSend(e)
      }) : l.blobToBinaryString(i, function(e) {
        n._bufferedSend(e)
      })
    ...
    switch (e.type) {
    case "ANSWER":
      d.handleSDP(e.type, this, t.sdp);
      break;
    case "CANDIDATE":
      d.handleCandidate(this, t.candidate);
      break;
    default:
      l.warn("Unrecognized message type:", e.type, "from peer:", this.peer)
    }
  }, l.inherits(p, s), p._idPrefix = "mc_", p.prototype.addStream = function(e) {
    l.log("Receiving stream", e), this.remoteStream = e, this.emit("stream", e)
  }, p.prototype.handleMessage = function(e) {
    var t = e.payload;
    switch (e.type) {
    case "ANSWER":
      d.handleSDP(e.type, this, t.sdp), this.open = !0;
      break;
    case "CANDIDATE":
      d.handleCandidate(this, t.candidate);
      break;
  ...
  }, p.prototype.answer = function(e) {
    if (this.localStream) {
      l.warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
      return
    }
    this.options._payload._stream = e, this.localStream = e, d.startConnection(this, this.options._payload);
  ...
  d._idPrefix = "pc_", d.startConnection = function(e, t) {
    var n = d._getPeerConnection(e, t);
    e.type === "media" && t._stream && n.addStream(t._stream), e.pc = n;
    if (t.originator) {
      if (e.type === "data") {
        var r = {};
        l.supports.sctp || (r = {
      ...
      l.supports.onnegotiationneeded || d._makeOffer(e)
    } else d.handleSDP("OFFER", e, t.sdp)
  }, d._getPeerConnection = function(e, t) {
    d.pcs[e.type] || l.error(e.type + " is not a valid connection type. Maybe you overrode the `type` property somewhere."), d.pcs[e.type][e.peer] || (d.pcs[e.type][e.peer] = {});
    var n = d.pcs[e.type][e.peer],
      r;
    t.pc && (r = d.pcs[e.type][e.peer][t.pc]);
    if (!r || r.signalingState !== "stable") r = d._startPeerConnection(e);
    return r
  }, d._startPeerConnection = function(e) {
    l.log("Creating RTCPeerConnection.");
    var t = d._idPrefix + l.randomToken(),
      n = {};
    e.type === "data" && !l.supports.sctp ? n = {
      optional: [{
        RtpDataChannels: !0
      }]
    } : e.type === "media" && (n = {
    ...
    return d.pcs[e.type][e.peer][t] = r, d._setupListeners(e, r, t), r
  }, d._setupListeners = function(e, t, n) {
    var r = e.peer,
      i = e.id,
      s = e.provider;
    l.log("Listening for ICE candidates."), t.onicecandidate = function(t) {
      t.candidate && (l.log("Received ICE candidates for:", e.peer), s.socket.send({
        type: "CANDIDATE",
        payload: {
      ...
      case "disconnected":
      case "failed":
        l.log("iceConnectionState is disconnected, closing connections to " + r), e.close();
        break;
      case "completed":
        t.onicecandidate = l.noop
      }
    }, t.onicechange = t.oniceconnectionstatechange, l.log("Listening for `negotiationneeded`"), t.onnegotiationneeded = function() {
      l.log("`negotiationneeded` triggered"), t.signalingState == "stable" ? d._makeOffer(e) : l.log("onnegotiationneeded triggered when not stable. Is another connection being established?")
    }, l.log("Listening for data channel"), t.ondatachannel = function(e) {
      l.log("Received data channel");
      var t = e.channel,
        n = s.getConnection(r, i);
      n.initialize(t)
    }, l.log("Listening for remote stream"), t.onaddstream = function(e) {
      l.log("Received remote stream");
      var t = e.stream;
      s.getConnection(r, i).addStream(t)
    }
  }, d.cleanup = function(e) {
    l.log("Cleaning up PeerConnection to " + e.peer);
    var t = e.pc; !! t && (t.readyState !== "closed" || t.signalingState !== "closed") && (t.close(), e.pc = null)
  }, d._makeOffer = function(e) {
    var t = e.pc;
    t.createOffer(function(n) {
      l.log("Created offer."), !l.supports.sctp && e.type === "data" && e.reliable && (n.sdp = u.higherBandwidthSDP(n.sdp)), t.setLocalDescription(n, function() {
        l.log("Set localDescription: offer", "for:", e.peer), e.provider.socket.send({
          type: "OFFER",
          payload: {
            sdp: n,
            type: e.type,
            ...
            metadata: e.metadata,
            connectionId: e.id,
            sctp: l.supports.sctp
          },
          dst: e.peer
        })
      }, function(t) {
        e.provider.emit("error", t), l.log("Failed to setLocalDescription, ", t)
      })
    }, function(t) {
      e.provider.emit("error", t), l.log("Failed to createOffer, ", t)
    }, e.options.constraints)
  }, d._makeAnswer = function(e) {
    var t = e.pc;
    t.createAnswer(function(n) {
      l.log("Created answer."), !l.supports.sctp && e.type === "data" && e.reliable && (n.sdp = u.higherBandwidthSDP(n.sdp)), t.setLocalDescription(n, function() {
        l.log("Set localDescription: answer", "for:", e.peer), e.provider.socket.send({
          type: "ANSWER",
          payload: {
            sdp: n,
            type: e.type,
      ...
      e.provider.emit("error", t), l.log("Failed to create answer, ", t)
    })
  }, d.handleSDP = function(e, t, n) {
    n = new RTCSessionDescription(n);
    var r = t.pc;
    l.log("Setting remote description", n), r.setRemoteDescription(n, function() {
      l.log("Set remoteDescription:", e, "for:", t.peer), e === "OFFER" && d._makeAnswer(t)
    }, function(e) {
      t.provider.emit("error", e), l.log("Failed to setRemoteDescription, ", e)
    })
  }, d.handleCandidate = function(e, t) {
    var n = t.candidate,
      r = t.sdpMLineIndex;
    e.pc.addIceCandidate(new RTCIceCandidate({
      sdpMLineIndex: r,
      candidate: n
    })), l.log("Added ICE candidate for:", e.peer)
  }, l.inherits(v, s), v.prototype.start = function(e) {
    this.id = e;
    var t = l.randomToken();
    this._httpUrl += "/" + e + "/" + t, this._wsUrl += "&id=" + e + "&token=" + t, this._startXhrStream(), this._startWebSocket()
  }, v.prototype._startWebSocket = function(e) {
    var t = this;
    ...
    this._socket = new WebSocket(this._wsUrl), this._socket.onmessage = function(e) {
      ...
      try {
        ...
        l.log("Invalid server message", e.data);
        return
      }
      t.emit("message", n)
      ...
      }, 5e3)), t._sendQueuedMessages(), l.log("Socket open")
    }
  }, v.prototype._startXhrStream = function(e) {
    try {
      var t = this;
      ...
      l.log("XMLHttpRequest not available; defaulting to WebSockets")
    }
  }, v.prototype._handleStream = function(e) {
    ...
    if (s) {
      ...
      if (e._index === t.length) e._buffer || (e._buffer = []), e._buffer.push(e._index - 1);
        ...
        try {
          ...
          l.log("Invalid server message", s);
          return
        }
        this.emit("message", s)
      }
    }
  }, v.prototype._setHTTPTimeout = function() {
    var e = this;
    this._timeout = setTimeout(function() {
      var t = e._http;
      e._wsOpen() ? t.abort() : (e._startXhrStream(t._streamIndex + 1), e._http.old = t)
    }, 25e3)
  }, v.prototype._wsOpen = function() {
    return this._socket && this._socket.readyState == 1
  }, v.prototype._sendQueuedMessages = function() {
